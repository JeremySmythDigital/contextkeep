...
export class Compactor {
     ...
     */
    includeMedium(preserved, mediumValance) {
     ...
     */
    compressMediumLow(mediumValance, lowValance) {
     ...
     */
    summarizeAll(mediumValance, lowValance) {
     ...
     */
    estimateTokensFromResult(preserved, compacted) {
