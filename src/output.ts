...
import { CompactionResult, ContentItem } from './types.js';

/**
 * Format compaction result as JSON
 */
export function formatResult(result: CompactionResult): string {
 ...
 */
export function parseResult(json: string): CompactionResult {
 ...
 */
export function createSummary(result: CompactionResult): string {
 ...
 */
export function createMinimalOutput(result: CompactionResult): string {
  const parts: string[] = [];
 ...
 */
export function calculateStats(result: CompactionResult): {
